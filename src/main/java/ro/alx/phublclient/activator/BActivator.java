...
public class BActivator implements BundleActivator {
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        props.put("osgi.command.function", new String[]{"marshal", "unmarshal", "marshalWithoutClassloader", "marshalWithClassloader", "getARSchemaWithoutClassloader", "getARSchemaWithClassloader"});
